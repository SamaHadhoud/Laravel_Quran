...
@section ('body')
    ...
    <div class="container-fluid landing ">
        <div class="container mid  {{(App::isLocale('ar') ? 'text-start' : 'text-end')}}">
           <button type="button" class="btn mt-4 me-1 p-3 bplay fa-lg text-white"><i class="fa-solid fa-play pe-1 ps-1 bplay"></i> {{__('Play Radio')}}  </button>
            <div class= "centerim mt-5 text-center">
            ...
            <div class="container align-items-center justify-content-center">
                <div class="row height d-flex justify-content-center align-items-center">
                    <div class="col-12 col-md-10">
                        ...
                        <div class="search form" method="GET" >
                            <span>
                            <select class="input-select fa-xl" name="cat" id="cat">
                                <option value="Surah"> {{__('Surah')}}</option>
                                <option value="Juz" > {{__('Juz')}} </option>
                                <option value="Page"> {{__('Page')}}</option>
                            </select>
                            </span>

                            <input name= "search" type="search" id="search" class="form-input form-control " placeholder="{{__("What do you want to read ?")}}" >
                            <div id="display"></div>
                            <span>
                            <button class="search-btn bg-white fa-xl">{{__("Search")}}</button>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class = "container mt-3 text-center " >
                    <a href='/{{'67'}}' class="btn swar p-1 fs-5 m-2 ps-3 pe-3 bg-white" role="button" aria-pressed="true">{{__("Al Mulk")}} </a>
                    <a href='/{{'36'}}' class="btn swar p-1 fs-5 m-2 ps-3 pe-3 bg-white"  role="button" aria-pressed="true" > {{__("Ya-Sin")}}</a>
                    <a href='/{{'18'}}' class="btn swar p-1 fs-5 m-2 ps-3 pe-3 bg-white" role="button" aria-pressed="true">{{__("Al Kahf")}}</a>
                    <a href='/{{'56'}}' class="btn swar p-1 fs-5 m-2 ps-3 pe-3 bg-white" role="button" aria-pressed="true" >{{__("Al Waqi'ah")}}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container" style="margin-top: 20px;">
        ...
        <ul class="nav nav-tabs ">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#surah">{{__('Surah')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#juz">{{__('Juz')}}</a>
            </li>
        </ul>
    <!-- Tab panes -->
    ...
    <div class="tab-content">
        <!-------------------------------- Tab surah ------------------------------------------------------>
        <div class="tab-pane container active mt-5"  id="surah">
            <div class= "row d-flex justify-content-between align-content-stretch row-cols-1 row-cols-md-3 row-cols-lg-4">
        ...
        <!------------------------------ Tab Juz ----------------------------------------------------------->
        <div class="tab-pane container fade mt-5" id="juz">
            <div class= "row d-flex justify-content-between align-content-stretch row-cols-1 row-cols-md-3 row-cols-lg-4">
                @foreach ($juzs as $juz)
                    <x-juz-card :juz="$juz" />
                @endforeach
