...
@props(['juz'])
<div class="col m-1 flex-fill bg-light justify-content-center align-content-center" >
    <div class="m-2 fs-5 " onclick="location.href='/juz/{{$juz->id}}'" style="cursor: pointer;" > {{$juz[__('En')]}}</div>
        ...
        <div class="container border m-1 diam">
            <div class ="row d-flex justify-content-between ">
                <div class="col col-9 d-flex justify-content-start">
                    <div class ="row d-flex justify-content-start align-iteSms-center">
