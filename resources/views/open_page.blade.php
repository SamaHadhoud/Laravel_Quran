        ...
        <div class="tab-content">
            ...
            <div class="tab-pane container active mt-5"  id="Reading">
                <div class ="container text-center" style = "width: 65%;">
                    <div id ="Start"> </div>
                @foreach ($page->ar_ayats as $ar_aya)
                     @if($ar_aya->aya == 1)
                        <div class ="container text-center" style="margin-top: 50px;">
                            <h class="fs-1" >سُورَةُ {{$ar_aya->surah->Ar}}  </h>
                        </div>
                ...
                @endforeach
                <div class = "fs-4 border-down"> {{$page->id}} <br></div>
                <hr>
            </div>
            <div class="container" style="margin-top: 50px;">
                <ul class="nav felx justify-content-center">
                    @if( $page->id+1 != 604)
                        <li class="nav-item">
                            <a class="btn btn-light p-2 pe-3 ps-3" href="/page/{{ $page->id+1}}">{{__("Next Page")}}</a>
                        </li>
                    @endif
                    <li class="nav-item">
                        <a class="btn btn-light p-2 pe-3 ps-3" href="#Start">{{__("Beginning of Page")}} </a>
                    </li>
                    @if( $page->id+1 !=0)
                        <li class="nav-item">
                            <a class="btn btn-light p-2 pe-3 ps-3" href="/page/{{ $page->id-1}}">{{__("Previous Page")}} </a>
                        </li>
                    @endif
                </ul>
            </div>
        ...
        <div class="tab-pane container fade mt-5" id="Translation">
            ...
            <div class="container" style="margin-top: 50px;">
                <ul class="nav felx justify-content-center">
                    ...
                    @endif
                    <li class="nav-item">
                        <a class="btn btn-light  p-2 pe-3 ps-3" href="#Start2">{{__("Beginning of Page")}} </a>
                    </li>
                    @if( $page->id+1 != 0)
                        <li class="nav-item">
                            <a class="btn btn-light  p-2 pe-3 ps-3" href="/page/{{$page->id-1}}">{{__("Previous Page")}} </a>
